<header class="container-fluid bg-white" style="top:0; position: absolute;">
    <nav id="navbar-website" class="navbar navbar-expand-lg navbar-light container fixed-top d-none d-md-flex">
    ...
    <div class="d-flex d-md-none mt-2">
        <a class="btn btn-outline-secondary" href="{{ route('home') }}">Powrót do strony</a>
    </div>
</header>
