...
@section('content')
    ...
    <form action="{{ route('admin.clients.update', $id) }}" method="POST" enctype="multipart/form-data" class="row">
        @csrf
        @method('PATCH')
            ...
            <div class="main-card card">
                <div class="card-body">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input name="surname" type="text"
                                       ...
                                       value="{{ old('surname', $surname) }}" required>
                    ...
                    <div class="form-group mt-4">
                        <label>Notatka</label>
                        <textarea name="note"
                                  class="form-control @error('note') is-invalid @enderror">{{ old('note', $note) }}</textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="city" type="text"
                               ...
                               value="{{ old('city', $city) }}" required disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input name="postcode" type="text"
                               ...
                               value="{{ old('postcode', $postcode) }}" required>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input name="building_nr" type="text"
                                       ...
                                       value="{{ old('building_nr', $building_nr) }}" required>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input name="stair_case" type="text"
                                       ...
                                       value="{{ old('stair_case', $stair_case) }}">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input name="stair_case_code" type="text"
                                       ...
                                       value="{{ old('stair_case_code', $stair_case_code) }}">
